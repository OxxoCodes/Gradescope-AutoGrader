...
# Runs the program
def runProgram(executable: str = None, inputFile: str = None, txtContents: str = None, timeout: float = 0.1, args: list = []) -> str:
    """
    ...
    args - list of strings containing any additiona command-line arguments (excluding the executable)
    """
    ...
    try:
        ...
        results = subprocess.run(cmdLineArgs, 
