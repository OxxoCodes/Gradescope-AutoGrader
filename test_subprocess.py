...
class Test01_Setup(unittest.TestCase):
    ...
    files = ['Calculator.cpp', 'Calculator.h', 'Driver.cpp', 'makefile']
    ...
    # Use `number` to specify how you want the test cases to be ordered on Gradescope. This does NOT
    # affect what order the tests actually run in - it only affects how they are be displayed.
    ...
    def test_Compile(self):
        ...
        # Don't remember why, but I could only ever get compilation to consistenly work when using the old
        # method, instead of my new `runProgram()` function. May be something to look into for the future but,
